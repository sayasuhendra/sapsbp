...
<body>
	...
	echo '
		...
		<form method="post" name="form" action="proseseditim.php" onsubmit="return validasi()" enctype="multipart/form-data">
		<table class="tbrule" cellspacing="10px">
			...
			<tr>				
				...
				<td><select name="cur">
                                       ...
                                       </select><input type="text" name="biayain" class="selectform" value="'.$edit['biayain'].'" ><span style="font-size:10px;">&nbsp;* Tidak Boleh Menggunakan titik atau koma</span>
				</td>
			</tr>
			<tr>				
				...
				<td><select name="curbul">
                                        ...
                                        <option value="$">$</option>
										<option value="$ Singapore">$ Singapore</option>
                                       </select><input type="text" name="biayabul" value="'.$edit['biayabul'].'" class="selectform" ><span style="font-size:10px;">&nbsp;* Tidak Boleh Menggunakan titik atau koma</span>
				</td>
			</tr>
			<tr>				
				<td valign="top">Keterangan</td>
				<td valign="top">:</td>
				<td><textarea name="keterangan" cols="29" rows="5" style="padding:5px;">'.$edit['keterangan'].'</textarea>
				</td>
			</tr>
			<tr>				
			...
			<tr>				
				...
				<td>:</td>
				<td><input type="text" name="jenpek" class="selectform" value="'.$edit['jenis_pekerjaan'].'" readonly="true">
				</td>
			</tr>
			<tr>				
				<td>Nama Sales</td>
