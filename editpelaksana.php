...
<body>
	...
	echo'
		<h3 class="judulok">Form Edit Pelaksana untuk pelanggan '.$dataim['namapers'].'</h3>
		<form method="post" name="formfpa" action="updatepelaksana.php">
		...
		<table>	
			...
			<tr>				
				...
				<td>
					...
					$pilihsup="select * from usr_tb where level='Staff' and bagian='Teknikal' or level='Engineer' and bagian='Teknikal'";
