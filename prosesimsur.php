...
<body>
	...
	<div id="isi">
		...
		$nofpb='SBP/FPS/'.$waktuok.'/'.$nourutok1;
		$nourut='1';
		...
		$noim=$nourutok.'/SBP-'.$area.'/Survey/'.$roma.'/'.$tahun;
		...
		$inputdata="INSERT INTO instal_im (tglupim,tglim,status_inven,media_akses,akses_speed,status_im,status_tm,status_fin,status_close,jenis_pekerjaan,noim,nourut,nofpb,namapers,alamat,cp,telp,email,jasa,tglrfs,keterangan,tujuan,status,nama_sales) VALUES ('$waktu','$tanggal','$statinven','$media','$speed','$statim','$stattm','$statfin','$statclose','$jenpek','$noim','$nourutok1','$nofpb','$namapers','$alamat','$cp','$telp','$email','$jasa','$tglrfs','$keterangan','$tujuan','$status','$sales')";
		...
		$isireport='Internal Memo Baru Survey telah di kirim oleh <b>'.$sales.'</b> untuk perusahaan <b>'.$namapers.'</b>. Dengan layanan jasa yang di pilih adalah <b>'.$jasa.'</b>. Untuk kontak person bisa menghubungi <b>'.$cp.'</b> di Nomor '.$telp.'';
		...
		echo '<p>Terimakasih '.$sales.' data internal memo Survey sudah di kirimkan ke departement DCO  untuk segera ditindaklanjuti</p>
