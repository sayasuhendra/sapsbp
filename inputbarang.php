...
<body>
	...
	echo '
		...
		<form method="post" name="form" action="prosesbrst.php" onsubmit="return validasi()" enctype="multipart/form-data">
			<table class="tbrule" cellspacing="10px">
			 ...
			 <tr>
				<td>Serial Number</td>
				<td>:</td>
				<td><input type="text" name="sernum" required placeholder="required"></td>
			 </tr>
			 <tr>
				<td>Merk</td>
				<td>:</td>
			 ...
			 <tr>
				...
				<td valign="top">:</td>
				<td><textarea name="keterangan" cols="38" rows="6"></textarea></td>
			 </tr>
			 <tr>				
				<td></td>
				<td></td>
