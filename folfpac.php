...
<body>
	...
	<form method="post" name="form" action="updatefpac.php" id="form" onsubmit="return validasi()" enctype="multipart/form-data">
	<?php
	...
	echo '
		...
		$datafpa=mysql_fetch_array($eksfpa);
			...
			<tr>				
				<td valign="top">Perangkat Di Pelanggan</td>
				<td valign="top">:</td>
			...
			<tr>				
				...
				<td><input type="checkbox" name="pok" id="pok" value="OK">&nbsp;Pengajuan Surat Terminasi</td>
			</tr>
			<tr>
				<td valign="top" class="text-contact">Upload Surat Terminasi<span style="color:red; font-size;9px;">*</span></td>
				<td valign="top" class="text-contact">:</td>
		        <td valign="top" class="text-contact"><input type="file" name="fupload" required placeholder="Required"><input type="hidden" name="namalengkap" value="'.$namauser.'"><input type="hidden" name="bagian" value="'.$bagian.'"></td>
			</tr>
			';}
			else{
			echo '
			...
			<tr>				
				<td></td>
				<td></td>
				<td><input type="hidden" name="status" value="Pending"> <input type="hidden" name="bagian" value="'.$bagian.'"></td>
			</tr>';
