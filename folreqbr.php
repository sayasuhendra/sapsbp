...
<body>
	...
	?>
	<div id="isi">
	<form method="post" name="form" action="updatereqbr.php" id="form" onsubmit="return validasi()">
	...
	<h3 class="judulok">Followup Permintaan Barang</h3>
		...
		$databar=mysql_fetch_array($eksbar);
			...
			<tr>				
				<td valign="top"></td>
				<td valign="top"></td>
				<td><span style="font-size:11px;">&nbsp;* Jika Memilih Status Revisi Atau Reject Silahkan tuliskan Alasan</span>
				</td>
			</tr>
			<tr>				
