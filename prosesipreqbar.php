...
<body>
	...
	echo'
		...
		mail($to,$subject,$message,$headers);                
        	...
        	$update_im="update instal_im SET tglupspk='$waktu', tujuan='$pelaksana', status_spk='OK', ipadd='$ipadd', netmask='$netmask', gateway='$ipgw', iptambah='$ipalo' where noim='$noim'";
		...
		$isireport='IP Address telah di isi oleh Engineer Area '.$area.' :'.$datauser['nama_lengkap'].'. Dan Request Barang Telah di Ajukan ke Bagian Inventory';
