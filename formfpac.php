...
<body>
	...
	echo '
		...
		<form method="post" name="formfpa" action="prosesfpac.php">
		...
		$datapers=mysql_fetch_array($ekspers);
			...
			<tr>				
				...
				<td>:</td>
				<td><input type="text" readonly="true" name="akstat" class="selectform" value="'.$datapers['jenis_pekerjaan'].'">
				</td>
			</tr>
			<tr>				
				<td>Akses Speed</td>
				<td>:</td>
				<td><input type="text" name="speed" class="selectform" value="'.$datapers['akses_speed'].'"></td>
			</tr>
			<tr>				
			...
			<tr>				
				...
				<td>:</td>
				<td><input type="text" name="target" readonly="true" class="selectform" value="'.$datapers['tglrfs'].'">
				</td>
			</tr>
			<tr>				
