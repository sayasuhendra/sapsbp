...
<link href="style.css" rel="stylesheet" type="text/css" />
  ...
  <script type="text/javasciptr" src="js/jquery.dcmegamenu.1.3.3.js"></script>
	...
	<div id="isi2">
		...
		<table width="990px" style="margin-left:-10px">
				   <tr>
					...
					<img src="images/logokecil.png" style="margin-top:-30px">
...
operation starting from : '.$datafpa2['tglrfs'].'</p></td>
				   ...
				   <tr>
					<td colspan="3" class="tdaneh2" valign="top">
						<p style="border-bottom:solid 1px #111111; margin-bottom:0px; font-size:19px;">Checklist</p>
						<table>
							<tr>	
