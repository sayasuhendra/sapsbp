	...
	echo '
		...
		$ekspers=mysql_query($pilihpers);
			...
			<tr>				
				...
				<td>:</td>
				<td><input type="text" id="namapers" name="namapers" class="selectform" value="Kebutuhan Internal">
				</td>
			</tr>
			...
			<tr>				
				<td>Jenis Barang</td>
				<td>:</td>
				<td><input type="text" name="jenis" class="selectform"></td>
			</tr>
			<tr>				
				<td valign="top">Merek barang</td>
				<td valign="top">:</td>
				<td><input type="text" name="merk" class="selectform">
				</td>
			</tr>
			<tr>				
				<td valign="top">Type</td>
				<td valign="top">:</td>
				<td><input type="text" name="type" class="selectform">
				</td>
			</tr>
			<tr>				
				<td valign="top">Jumlah Barang</td>
				<td valign="top">:</td>
				<td><input type="text" name="jumlah" class="selectform" width="10">
				</td>
			</tr>
			<tr>				
				<td valign="top">Vendor</td>
				<td valign="top">:</td>
				<td><input type="text" name="vendor" class="selectform" width="10">
				</td>
			</tr>
			<tr>				
