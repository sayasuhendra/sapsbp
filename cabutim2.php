...
<body>
	...
	<?php
		...
		$waktu=date("Ymd");
		$id=$_GET['noim'];
		$pilihcir="select * from instal_im inner join customer_data on instal_im.namapers=customer_data.nama_perusahaan where instal_im.noim='$id'";
	...
	echo '
		...
		<tr>				
			...
			<tr>				
				<td>CIR ID</td>
				<td>:</td>
				<td><input type="text" name="nopel" class="selectform" id="cirid" value="'.$datacir['cirid'].'" required autofocus><input type="hidden" name="nofpb" class="selectform" value="'.$datacir['nofpb'].'">
				</td>
			</tr>
			<tr>				
				<td valign="top">Alamat</td>
				<td valign="top">:</td>
				<td><textarea id="alamat" name="alamat" cols="29" rows="5" style="padding:5px;" required autofocus>'.$datacir['alamat_perusahaan'].'</textarea>
				</td>
			</tr>
			<tr>				
				<td>Kontak Person</td>
				<td>:</td>
				<td><input type="text" name="cp" class="selectform" id="cp" value="'.$datacir['cp_finance'].'" required autofocus>
				</td>
			</tr>
			<tr>				
			...
			<tr>				
				<td>Bandwidth</td>
				<td>:</td>
				<td><input type="text" name="speed" class="selectform" id="speed" required autofocus value="'.$datacir['bandwidth_client'].'">
				</td>
			</tr>
