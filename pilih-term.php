...
<body>
	...
	echo'
		<h3 class="judulok">Petunjuk Pelasksana Terminasi Untuk Pelanggan '.$dataim['namapers'].'</h3>
		<form method="post" name="formfpa" action="prosestunjukterm.php">
		...
		<table>	
			...
			<tr>				
				<td></td>
				<td></td>
				<td><input type="checkbox" name="rilis" id="rilis" value="OK" required>&nbsp;Rilis IP</td>
			</tr>
