...
<body>
	...
	<?php
		include "koneksi.php";
		$waktu=date("Ymd");
		$pilihcir="select * from customer_data order by nama_perusahaan ASC";
		$ekscir=mysql_query($pilihcir);
		
	echo '
		<h3 class="judulok">Form Internal Memo Upgrade  / Downgrade</h3>
		<form method="post" name="form" action="prosesmutasi.php" onsubmit="return validasi()">
		<table class="tbrule" cellspacing="10px">
			
			<tr>				
				<td>Nama Pelanggan</td>
				<td>:</td>
				<td><input type="text" name="namapers" id="namapers" class="selectform" required><input type="hidden" name="area" class="selectform" value="'.$area.'">
				</td>
			</tr>
			<tr>				
				<td valign="top">Alamat</td>
				<td valign="top">:</td>
				<td><textarea name="alamat" id="alamat" cols="29" rows="5" style="padding:5px;"></textarea>
				</td>
			</tr>
			<tr>				
				<td>Kontak Person</td>
				<td>:</td>
				<td><input type="text" name="cp" id="cp" class="selectform" required>
				</td>
			</tr>
			<tr>				
				<td>Telp / HP</td>
				<td>:</td>
				<td><input type="text" name="telp" class="selectform" required>
				</td>
			</tr>
			<tr>				
				<td>Email</td>
			...
			<tr>				
				...
				<td>
					<select name="services" required>
						...
						<option value="Internet braodband">Internet braodband</option>
			...
			<tr>				
				...
				<td><select name="media">
						...
						<option value="Cooper">Interconnection</option>
					</select>
				</td>
			</tr>
			...
			<tr>				
				<td>Bandwitdh</td>
				<td>:</td>
				<td><input type="text" name="speed" id="speed" class="selectform">
				</td>
			</tr>
			<tr>				
				<td>Tgl. Ready For Service</td>
				<td>:</td>
				<td><input type="text" name="rfs" class="selectform" id="datepicker" required>
				</td>
			</tr>
			<tr>				
			...
			<tr>				
				...
				<td valign="top">:</td>
				<td><input type="text" name="biayain" class="selectform" required><span style="font-size:10px;">&nbsp;* Tidak Boleh Menggunakan titik atau koma</span>
				</td>
			</tr>
			<tr>				
				<td valign="top">Biaya Bulanan</td>
				<td valign="top">:</td>
				<td><input type="text" name="biayabul" class="selectform" required><span style="font-size:10px;">&nbsp;* Tidak Boleh Menggunakan titik atau koma</span>
				</td>
			</tr>
			<tr>				
				<td valign="top">Keterangan</td>
				<td valign="top">:</td>
				<td><textarea name="keterangan" cols="29" rows="5" style="padding:5px;" placeholder="Tulis Keterangan Untuk Upgrade / Downgrade"></textarea>
				</td>
			</tr>
			<tr>				
			...
			<tr>				
				...
				<td>:</td>
				<td><input type="text" name="jenpek" class="selectform" value="Mutasi" readonly="true">
